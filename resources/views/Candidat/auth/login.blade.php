...
<div class="min-h-screen bg-purple-400 flex justify-center items-center">
	...
	<div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
		<div>
			<h1 class="text-3xl font-bold text-center cursor-pointer">LOGIN</h1>
        ...
        @csrf
                <div class="space-y-4">
                    <div>
                       ...
                       <input placeholder="Email" class="mt-2 block text-sm py-3 px-4 rounded-lg w-full border outline-none" type="email" name="email" :value="old('email')" required autofocus />
                    ...
                    <div>
                        ...
                        <input type="password" placeholder="Password" class="mt-2 block text-sm py-3 px-4 rounded-lg w-full border outline-none"   name="password" required autocomplete="current-password" />
                        <p class="mt-3 text-xs text-red-400">
                        <x-auth-validation-errors class="mb-4 text-center" :errors="$errors" />
                        </p>
                    </div>
                    ...
                    @if (Route::has('password.request'))
                     ...
                     @endif
                        <span class="underline cursor-pointer">
                            <a class="text-sm text-gray-600 hover:text-gray-900" href="{{ route('candidat.register') }}">
                             {{ __('Créer un compte') }}
                            </a>
                        </span>
		    		</p>
